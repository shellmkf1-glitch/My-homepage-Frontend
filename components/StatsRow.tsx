...
export default function StatsRow() {
  return (
    <section id="stats" className="rounded-[1.75rem] bg-slate-950 px-8 py-12 text-white shadow-soft">
      <div className="grid gap-8 md:grid-cols-2">
        {stats.map((item) => (
          <div key={item.label} className="rounded-3xl bg-slate-900/80 p-8 text-center">
